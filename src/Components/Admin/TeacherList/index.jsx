...
import { getTeacherList } from '../../../Redux/Actions/user';
        ...
        Swal.fire({
            ...
            if (result.value) {
                apiUser
                    ...
                    .then(() => {
                        Swal.fire({
                            title: 'Đã xoá giảng viên thành công!',
                            icon: 'success',
                            confirmButtonColor: '#e74c3c',
                            confirmButtonText: 'Ok',
                        }).then(() => props.getTeacherList())
                    })
            }
    ...
    return (
        <div className={classes.root, "mt-5"}>
            <Paper className={classes.paper, "container"}>
                ...
                <TablePagination
                    labelRowsPerPage="Số giảng viên mỗi trang"
...
const mapStateToProps = (state) => {
    return {
        teacherList: state.teacherReducer,
    }
}
